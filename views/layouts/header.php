...
<head>
    ...
    <title><?= htmlspecialchars($tituloPagina ?? 'Doméstik | Tienda en Línea de Electrodomésticos y Línea Blanca') ?></title>
    
    <!-- Meta Tags SEO -->
    <meta name="description" content="<?= htmlspecialchars($metaDescripcion ?? 'Doméstik: Tu tienda en línea especializada en electrodomésticos, refrigeración, lavado, cocina y climatización con las mejores marcas y garantía.') ?>">
    <meta name="keywords" content="electrodomésticos, línea blanca, refrigeradoras, lavadoras, estufas, microondas, aire acondicionado, Doméstik, compras en línea">
    <meta name="author" content="Doméstik Electrohogar">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars(BASE_URL . '/' . ($_SERVER['REQUEST_URI'] ?? 'index.php')) ?>">

    <!-- Open Graph (Facebook, WhatsApp, LinkedIn) -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?= htmlspecialchars($tituloPagina ?? 'Doméstik | Tienda en Línea de Electrodomésticos') ?>">
    <meta property="og:description" content="<?= htmlspecialchars($metaDescripcion ?? 'Compra electrodomésticos y línea blanca con entrega rápida y garantía en Doméstik.') ?>">
    <meta property="og:url" content="<?= htmlspecialchars(BASE_URL) ?>">
    <meta property="og:image" content="<?= BASE_URL ?>/public/img/og-preview.jpg">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= htmlspecialchars($tituloPagina ?? 'Doméstik | Tienda en Línea') ?>">
    <meta name="twitter:description" content="<?= htmlspecialchars($metaDescripcion ?? 'Los mejores electrodomésticos y línea blanca para tu hogar en Doméstik.') ?>">
    ...
    <?php if (isset($cssEspecifico)): ?>
        ...
        $versionCssEspecifico =
            file_exists($rutaCssEspecifico)
                ...
                : time();
        ?>
        <link rel="stylesheet" href="<?= BASE_URL ?>/public/css/<?= htmlspecialchars($cssEspecifico, ENT_QUOTES, 'UTF-8') ?>?v=<?= $versionCssEspecifico ?>">
    <?php endif; ?>

    <!-- Schema.org Datos Estructurados JSON-LD (SEO) -->
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Store",
      "name": "Doméstik Electrodomésticos",
      "image": "<?= BASE_URL ?>/public/img/og-preview.jpg",
      "description": "Tienda en línea especializada en electrodomésticos, refrigeración, lavado y línea blanca.",
      "url": "<?= BASE_URL ?>",
      "telephone": "+50222000000",
      "address": {
        "@type": "PostalAddress",
...
<body>
    ...
    <header class="site-header sticky-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom" aria-label="Navegación Principal">
        <div class="container">
